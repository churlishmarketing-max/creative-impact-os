...
6. **The approval gate applies to AI images exactly like Canva designs.** Generated image → thumbnail into the Approval Batch → a founder signs (Brandon or Emmanuel — either is sufficient) → then it ships. An AI image is an ASSET in the inbox format, nothing more exempt.
...
- [ ] Brand/design law honored if brand graphics present (navy grounds, gold the single accent, red once max; or client kit)?
